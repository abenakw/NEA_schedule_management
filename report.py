...
class reportClass:
    def __init__(self,root):
        ...
        btn_search=Button(self.root,text='Search',font=("goudy old style",15,"bold"),bg="#2196f3",fg="blue",cursor="hand2",command=self.search).place(x=680,y=100,width=100,height=35)
        btn_clear=Button(self.root,text='Clear',font=("goudy old style",15,"bold"),bg="#2196f3",fg="blue",cursor="hand2",command=self.clear).place(x=800,y=100,width=100,height=35)
        ...
        #button delete
        btn_delete=Button(self.root,text='Delete',font=("goudy old style",15,"bold"),bg="red",fg="blue",cursor="hand2",command=self.delete).place(x=500,y=350,width=150,height=35)
        ...
        try:
            if self.var_id=="":
                ...
                if row ==None:
                    ...
                    op=messagebox.askyesno("Confirm","Do you really want me to delete?",parent=self.root)
                    if op==True:
