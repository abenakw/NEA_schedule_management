...
class resultClass:
    def __init__(self,root):
        ...
        btn_search=Button(self.root,text='Search',font=("goudy old style",15,"bold"),bg="#2196f3",fg="blue",cursor="hand2",command=self.search).place(x=500,y=100,width=100,height=28)
        ...
        #to add photo watch from 15:51 onwards
